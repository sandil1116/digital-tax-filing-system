...
public class TaxFilingDAO {
    ...
    public static ResultSet getAllFilingsWithDetails() {
        String sql = "SELECT f.filingID, t.name, t.email, f.taxAmount, f.status, f.filingDate " +
                     "FROM filings f " +
                     "JOIN taxpayers t ON f.taxpayerID = t.taxpayerID " +
